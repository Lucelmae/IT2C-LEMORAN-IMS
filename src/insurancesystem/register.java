...
public class register extends javax.swing.JFrame {
 ...
 private final Color hoverColor = new Color(180, 180, 180); // Grayish color on hover
         private final Color defaultColor = new Color(255, 255, 255); // Default white color
    ...
    private void create_accMouseClicked(java.awt.event.MouseEvent evt) {                                        
        LOGIN log = new LOGIN();
        log.setVisible(true);
        this.dispose();
    }                                       
